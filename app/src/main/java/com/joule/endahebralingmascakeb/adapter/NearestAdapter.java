...
public class NearestAdapter extends RecyclerView.Adapter<NearestAdapter.viewHolder> {
    ...
    public NearestAdapter(Context context, ArrayList<ModelDestination> modelDestinations) {
    ...
    public viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_nearest, parent, false);
    ...
    public class viewHolder extends RecyclerView.ViewHolder {
        ...
        public viewHolder(@NonNull View itemView) {
            super(itemView);
            imageView = itemView.findViewById(R.id.img_nearest);
            textView = itemView.findViewById(R.id.tv_name_nearest);
        }
    }
}
